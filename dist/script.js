...
var checkNumInputs = function checkNumInputs(selector) {
  ...
  numINputs.forEach(function (elem) {
...
var modals = function modals(state) {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var checkLengthOfState = arguments.length > 4 ? arguments[4] : undefined;
    ...
    trigger.forEach(function (elem) {
      elem.addEventListener('mouseover', function () {
        var sizeOfState = Object.keys(state).length;
...
var timer = function timer(id, deadline) {
  ...
  var getTimeRemaining = function getTimeRemaining(endtime) {
    ...
    seconds = Math.floor(t / 1000 % 60),
        ...
        days = Math.floor(t / (1000 * 60 * 60 * 24)); // возвращаем в виде объекта
  ...
  var setClock = function setClock(selector, end) {
    ...
    updateClock(); // Распределяем значения времени по переменным и передаём на страницу
